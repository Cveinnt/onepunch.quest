<script>
  ...
  import Sponsor from "./Menu/Sponsor.svelte";
  ...
  onMount(() => {
    ...
    if (
      $state.page === "Home" &&
      localStorage.installPromptShown === "false" &&
  ...
  // if user came here after a certain amount of days, reset his training or test
  // ------------------------------------------------------------------------
